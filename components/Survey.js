...
const Survey = ({ hidden = false }) => {
    ...
    return (
        <div hidden={hidden}>
            ...
            <form className={styles.form} name="langle-branch-1" method="POST" data-netlify="true" onSubmit={handleSubmit}>
                <input type="hidden" name="form-name" value="langle-branch-1" />
